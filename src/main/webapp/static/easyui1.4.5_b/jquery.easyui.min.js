        ...
        return this.each(function () {
            ...
            function _84(e) {
                ...
                if (e.pageX > _87.left && e.pageX < _87.left + _8a) {
                    ...
                    //zoom缩放后，表格title拖动更改e.pageX比例，pls，2019-3-8
                    if (e.pageX / zoomValue() < _87.left + _88 && e.pageX / zoomValue() > _87.left + _88 - _8a - 3) {
                        dir += "e";
                    }
                    //zoom缩放后，表格title拖动更改e.pageX比例，pls，2019-3-8
                }
...
(function ($) {
    function _ab(_ac) {
        ...
        for (var _b1 = 0; _b1 < aa.length; _b1++) {
            ...
            if (_b2 == "list") {
                ...
                $("<td class=\"iconfont icon-paginationPageList\"></td>").append(ps).appendTo(tr);
            } else {
                if (_b2 == "sep") {
    ...
    function _c5(_c6, _c7) {
        ...
        if (_c9.showRefresh && _c8.bb.refresh) {
            _c8.bb.refresh.linkbutton({iconCls: (_c9.loading ? "pagination-loading" : "pagination-load iconfont icon-paginationLoad")});
        }
    };
    ...
    $.fn.pagination.defaults = {
        ...
        nav: {
            first: {
                iconCls: "pagination-first iconfont icon-paginationFirst", handler: function () {
                ...
                iconCls: "pagination-prev iconfont icon-paginationPrev", handler: function () {
                ...
                iconCls: "pagination-next iconfont icon-paginationNext", handler: function () {
                ...
                iconCls: "pagination-last iconfont icon-paginationLast", handler: function () {
                ...
                iconCls: "pagination-refresh iconfont icon-paginationreFresh", handler: function () {
    ...
    function _1f4(_1f5) {
        ...
        if ($(_1f5).is(":visible")) {
            ...
            if (opts.position == "top" && pos.top < 0) {
                ...
                if ((opts.position == "bottom") && (pos.top + tip._outerHeight() > $(window)._outerHeight() / zoomValue() + $(document).scrollTop())) {
                    pos = _1f7("top");
                }
            }
            if (pos.left < 0) {
                ...
                if (pos.left + tip._outerWidth() > $(window)._outerWidth() / zoomValue() + $(document)._scrollLeft()) {
                    if (opts.position == "right") {
                        pos = _1f7("left");
                    } else {
                        var left = pos.left;
                        pos.left = $(window)._outerWidth() / zoomValue() + $(document)._scrollLeft() - tip._outerWidth();
...
(function ($) {
    ...
    function _20e(node) {
		// ghh 弹窗关闭是检查父级是否已锁定滚动 并取消锁定 start
        var n = node[0] || {};
        var p = node.parent()[0] || {};
        if (n.fitted) {
            n.fitted = false;
        ...
        function _224() {
            if (opts.noheader || (!opts.title && !opts.header)) {
                ...
                if (opts.header) {
                    ...
                    if (opts.collapsible) {
                        _22a(tool, "panel-tool-collapse iconfont icon-collapse", function () {
                    ...
                    if (opts.minimizable) {
                        _22a(tool, "panel-tool-min iconfont icon-toolMin", function () {
                            _24e(_221);
                        });
                    }
                    if (opts.maximizable) {
                        _22a(tool, "panel-tool-max iconfont icon-toolMax", function () {
                    ...
                    if (opts.closable) {
                        _22a(tool, "panel-tool-close iconfont icon-toolClose", function () {
                            _23c(_221);
                        });
                    }
                }
    ...
    function _23b(_245, _246) {
        ...
        tool.addClass("panel-tool-expand iconfont icon-expand");
        if (_246 == true) {
    ...
    function _248(_249, _24a) {
        ...
        tool.removeClass("panel-tool-expand icon-expand");
        if (_24a == true) {
    ...
    function _23a(_24c) {
        ...
        tool.addClass("panel-tool-restore iconfont icon-toolRestore");
    ...
    function _251(_252) {
        ...
        _253.show();
        tool.removeClass("panel-tool-restore iconfont icon-toolRestore");
...
(function ($) {
    function _272(_273, _274) {
        ...
        //弹框定位修改 wxg 2019-3-12
        if (zoomValue() !== 1) {
            _275.options.top /= zoomValue()
            _275.options.left /= zoomValue()
            var $ph = $(_273).parent('.panel').height()
            var $pw = $(_273).parent('.panel').width()
            _275.options.top+=($ph / zoomValue() - $ph)/2
            _275.options.left+=($pw / zoomValue() - $pw)/2
        }
    ...
    function _280(_281) {
        ...
        var win = $(_281).panel($.extend({}, _282.options, {
            ...
            onOpen: function () {
                //适配小屏幕遮罩层
                let obj = $.fn.window.getMaskSize(_281);
                obj.width = obj.width / zoomValue()
                obj.height = obj.height / zoomValue()
                if (_282.mask) {
    ...
    $(window).resize(function () {
        $("body>div.window-mask").css({
            width: $(window)._outerWidth() / zoomValue(),
            height: $(window)._outerHeight() / zoomValue()
        });
        setTimeout(function () {
            var obj = $.fn.window.getMaskSize();
            obj.width = obj.width / zoomValue()
            obj.height = obj.height / zoomValue()
            $("body>div.window-mask").css(obj);
        }, 50);
    });
...
(function ($) {
    ...
    $.messager = {
        show: function (_2b5) {
            return _2af(_2b5);
        }, alert: function (_2b6, msg, icon, fn, msgIcon, isClose, duration) {
            ...
            var statusIcon = "";
            var closeIcon = "";
            typeof opts.fn !== 'function' ? opts.fn = undefined : "";
            typeof opts.msgIcon !== 'string' ? opts.msgIcon = undefined : "";
            for (var i = 3; i < arguments.length; i++) {
                if (typeof arguments[i] === "string") {
                    opts.msgIcon = arguments[i];
                } else if (typeof arguments[i] === "boolean") {
                    opts.isClose = arguments[i];
                } else if (typeof arguments[i] === "number") {
                    opts.duration = arguments[i];
                }
            }
            opts = $.extend({}, $.messager.defaults, opts);
            //msgIcon 消息框图标
            if (opts.msgIcon === undefined || opts.msgIcon === "") {
                if (opts.msg.length <= 6 && opts.msg.indexOf("成功") != -1) {
                    statusIcon = "re-icon-success";
                } else {
                    statusIcon = "re-icon-notice";
                }
            } else if (opts.msgIcon === "notice") {
                statusIcon = "re-icon-notice";
            } else if (opts.msgIcon === "success") {
                statusIcon = "re-icon-success";
            } else if (opts.msgIcon === "error") {
                statusIcon = "re-icon-error";
            }
            //isClose 关闭消息框图标
            if (opts.isClose === undefined || opts.isClose === "") {
                if (opts.msg.length >= 50) {
                    closeIcon = "re-icon-close";
                } else {
                    closeIcon = "";
                }
            } else if (opts.isClose === false) {
                closeIcon = "";
            } else if (opts.isClose === true) {
                closeIcon = "re-icon-close";
            }
            //获取回调函数内容
            var changeFn = opts.fn.toString(); //回调函数转字符串
            var str = changeFn.match(/\{[\S\s]+\}/)[0].replace(/\s*/g, ""); //截取字符串里面的大括号并去掉括号里面的空格
            var subStr = str.match(/\{(\S*)\}/)[1]; //截取大括号之间的内容


            //mxApi.isPc()  false:手机端 true:PC

            if (!subStr || opts.fn === undefined || !opts.fn) {  //如果回调函数内容为空执行这一步
                opts.draggable = false;  //不可拖动
                opts.modal = false;  //遮罩层
                var dlg = _2b2(opts);
                dlg[0].parentNode.remove();

                if(mxApi.isPc()){
                    //duration 消息关闭时间
                    if (opts.duration === undefined || opts.duration === "") {
                        var t1 = opts.msg.length - 6;
                        var t2 = 3000 + parseInt((t1 * 0.1).toFixed(0)) * 1000;
                        opts.duration = t2;
                    }

                    opts.content = "<div></div>" + "<div>" + "<span class='re-message-icon'><i class=\"" + statusIcon + "\"></i></span>" + "<p class='re-msgox'>" + opts.msg + "</p>" + "<i class=\"" + closeIcon + "\"></i>" + "</div>" + "<div style=\"clear:both;\"/>";
                    var o = document.body;
                    var msgDiv = document.createElement("div");
                    var childClose = document.createElement("i");

                    msgDiv.innerHTML = "<div class='reWrapper' style='height:38px;'>" + "<span class='re-message-icon'><i class=\"" + statusIcon + "\"></i></span>" + "<p class='re-msgox'>" + opts.msg + "</p></div>" + "<div style=\"clear:both;\"/>";
                    msgDiv.id = "reMessageBox";
                    childClose.className = closeIcon;
                    o.appendChild(msgDiv);
                    var childIcon = msgDiv.childNodes[0].childNodes[0];
                    var list = msgDiv.childNodes;
                    for(var i in list){
                        if(list[i].className === 'reWrapper'){
                            reWrapper = list[i];
                        }
                    }
                    reWrapper.appendChild(childClose);

                    //消息框打开时下滑动画
                    var timer = setTimeout(function () {
                        msgDiv.style.top = "8px";
                        clearTimeout(timer);
                    }, 1);

                    //消息框颜色
                    if (statusIcon === "re-icon-success") {
                        msgDiv.style.backgroundColor = "#e0f6ed";
                        msgDiv.style.border = "1px solid #78b484";
                        msgDiv.style.color = "#4b9f5c";
                        childIcon.style.border = "1px solid #78b484";
                    } else if (statusIcon === "re-icon-error") {
                        msgDiv.style.backgroundColor = "#ffe7e7";
                        msgDiv.style.border = "1px solid #fab3b3";
                        msgDiv.style.color = "#cf6161";
                        childIcon.style.border = "1px solid #fab3b3";
                    }
                    ...
                    //匹配到“重新登录”，弹出登录弹框
                    if (opts.msg.indexOf("重新登录") != -1) {
                        var InfoMainUsername = $("#InfoMainUsername").html();
                        var InfoName = $("#InfoName").html();
                        window.reLogin(InfoName,InfoMainUsername);
                    }

                }else{
                    opts.content = "<div class='optsMsgBox'><p>"+opts.msg+"</p></div>";
                    var o = document.body;
                    var msgDiv = document.createElement("div");
                    msgDiv.innerHTML = opts.content;
                    msgDiv.id = "reMessageBox";
                    o.appendChild(msgDiv);
                    ...
                    if (opts.duration === undefined || opts.duration === "") {
                        var t1 = opts.msg.length - 6;
                        var t2 = 1500 + parseInt((t1 * 0.1).toFixed(0)) * 1000;
                        opts.duration = t2;
                    }

                    //手动关闭消息框
                    var NotAutoOff = function () {
                        msgDiv.id = "messageMask";
                    ...
                    if(opts.isClose === undefined){  //isClose:true   手动关闭
                        if (opts.msg.length < 50) {
                            AutoOff();
                        } else {
                            NotAutoOff();
                    ...
                    //匹配到“重新登录”，弹出登录弹框
                    if (opts.msg.indexOf("重新登录") != -1) {
                        if(top.app.userBaseInfo){
                            var userinfo = top.app.userBaseInfo;
                            var InfoMainUsername = userinfo.securityUserRelation[0]?userinfo.securityUserRelation[0].mainUsername:'';
                            var InfoName = userinfo.securityUser.username;
                            window.reLogin(InfoName,InfoMainUsername);
                        }
                    }
                }
                ...
                if(mxApi.isPc()){
                    opts.content = "<div class=\"" + cls + "\"></div>" + "<div >" + opts.msg + "</div>" + "<div style=\"clear:both;\"/>";
                    opts.closable = false;
                    if (!opts.buttons) {
                        opts.buttons = [{
...
(function ($) {
    ...
    function _335(_336) {
        ...
        $("<div class=\"tabs-header\">" + "<div class=\"tabs-scroller-left iconfont icon-tabsScrollerLeft\"></div>" + "<div class=\"tabs-scroller-right iconfont icon-tabsScrollerRight\"></div>" + "<div class=\"tabs-wrap\">" + "<ul class=\"tabs\"></ul>" + "</div>" + "</div>").prependTo(_336);
        ...
        if (_357.type == "all" || _357.type == "header") {
            ...
            if (opts.header) {
                ...
                if (opts.closable) {
                    ...
                    $("<a href=\"javascript:void(0)\" class=\"tabs-close iconfont icon-tabsClose\"></a>").appendTo(tab);
                } else {
...
(function ($) {
    ...
    function _412(_413, _414) {
        ...
        menu.css(opts.position.call(_413, menu[0], left / zoomValue(), top / zoomValue()));
...
(function ($) {
    ...
    $.fn.menubutton.defaults = $.extend({}, $.fn.linkbutton.defaults, {
        ...
        cls: {
            ...
            arrow: "m-btn-downarrow iconfont icon-downarrow",
            trigger: "m-btn"
        }
    });
})(jQuery);
...
(function ($) {
    ...
    function init(_573) {
        $(_573).addClass("calendar").html("<div class=\"calendar-header\">" + "<div class=\"calendar-nav calendar-prevmonth iconfont icon-calendarPrevmonth\"></div>" + "<div class=\"calendar-nav calendar-nextmonth iconfont icon-calendarNextmonth\"></div>" + "<div class=\"calendar-nav calendar-prevyear  iconfont icon-calendarPrevyear\"></div>" + "<div class=\"calendar-nav calendar-nextyear  iconfont icon-calendarNextyear\"></div>" + "<div class=\"calendar-title\">" + "<span class=\"calendar-text\"></span>" + "</div>" + "</div>" + "<div class=\"calendar-body\">" + "<div class=\"calendar-menu\">" + "<div class=\"calendar-menu-year-inner\">" + "<span class=\"calendar-nav calendar-menu-prev\"></span>" + "<span><input class=\"calendar-menu-year\" type=\"text\"></input></span>" + "<span class=\"calendar-nav calendar-menu-next\"></span>" + "</div>" + "<div class=\"calendar-menu-month-inner\">" + "</div>" + "</div>" + "</div>");
...
(function ($) {
    function _5a1(_5a2) {
        ...
        _5a6.append("<a href=\"javascript:void(0)\" class=\"spinner-arrow-up iconfont icon-spinnerArrowUp\" tabindex=\"-1\"></a>");
        _5a6.append("<a href=\"javascript:void(0)\" class=\"spinner-arrow-down iconfont icon-spinnerArrowDown\" tabindex=\"-1\"></a>");
        ...
        if (opts.toolbar) {
            if ($.isArray(opts.toolbar)) {
                ...
                for (var i = 0; i < opts.toolbar.length; i++) {
                    ...
                    } else if (btn == 'br') {//xyzxyzxyz start
                        tr = $('<tr></tr>');
                        tr.appendTo(tb.find('table'));
                    } else {//xyzxyzxyz end
                        var td = $("<td></td>").appendTo(tr);
                        var tool = $("<a href=\"javascript:void(0)\"></a>").appendTo(td);
                        tool[0].onclick = eval(btn.handler || function () {
            ...
            for (var i = 0; i < _635.length; i++) {
                ...
                for (var j = 0; j < cols.length; j++) {
                    ...
                    if (col.checkbox) {
                        ...
                        if (col.field) {
                            td.attr("field", col.field);
                            td.append("<div class=\"datagrid-cell\"><span></span><span class=\"datagrid-sort-icon iconfont icon-datagridSort\"></span></div>");
        ...
        _644.each(function () {
            $(this).resizable({
                ...
                onResize: function (e) {
                    ...
                    _641.proxy.css({left: e.pageX / zoomValue() - $(_642).offset().left - 1, display: "block"});
                    //zoom缩放后，表格title拖动更改e.pageX比例
                    return false;
                },
                onStopResize: function (e) {
                    _643.css("cursor", "");
    ...
    var _848 = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_849, _84a, _84b) {
            ...
            if ((_851 && (opts.rownumbers || opts.frozenColumns.length)) || (!_851 && !(opts.rownumbers || opts.frozenColumns.length))) {
                ...
                _854.push("<span class=\"datagrid-row-expander datagrid-row-collapse iconfont icon-datagridRowCollapseMin\">&nbsp;</span>");
                _854.push("</span>");
            }
            if (!_851) {
        ...
        groups: function (jq) {
            ...
            return jq.each(function () {
                ...
                if (_86b.hasClass("datagrid-row-expand")) {
                    _86b.removeClass("datagrid-row-expand iconfont icon-datagridRowExpandMin").addClass("datagrid-row-collapse iconfont icon-datagridRowCollapseMin");
            ...
            return jq.each(function () {
                ...
                if (_86e.hasClass("datagrid-row-collapse")) {
                    _86e.removeClass("datagrid-row-collapse iconfont icon-datagridRowCollapseMin").addClass("datagrid-row-expand iconfont icon-datagridRowExpandMin");
...
(function ($) {
    ...
    function _997(_998) {
        ...
        if (opts.hasDownArrow) {
            _99e.push({
                iconCls: "combo-arrow iconfont icon-comboArrow", handler: function (e) {
                    _9a2(e.data.target);
                }
            });
        }
    ...
    function _9a2(_9a3) {
        ...
        if(isPc()){
            $(_9a3).combo("textbox").focus(); //pls 5.27 判断pc，移动端不focus
        }
    };
    function isPc() {
...
opts.onSelect.call(_9e7,opts.finder.getRow(_9e7,_9e8));
    ...
    function _9eb(_9f1, _9f2, _9f3) {
        ...
        _9f4.find("div.combobox-item-selected").removeClass("combobox-item-selected iconfont icon-comboboxItemSelected");
        var _9f5 = null;
        var vv = [], ss = [];
        for (var i = 0; i < _9f2.length; i++) {
            var v = _9f2[i];
            var s = v;
            opts.finder.getEl(_9f1, v).addClass("combobox-item-selected iconfont icon-comboboxItemSelected");
    ...
    function _9fe(_9ff, q) {
        ...
        if (opts.mode == "remote") {
            ...
            _a02.find("div.combobox-item-selected,div.combobox-item-hover").removeClass("combobox-item-selected combobox-item-hover  iconfont icon-comboboxItemSelected");
            ...
            $.map(qq, function (q) {
                ...
                for (var i = 0; i < data.length; i++) {
                    var row = data[i];
                    /*pls2018-4-2增加下拉框拼音匹配****开始*/
                    var q1 = q;
                    if (row.searchkey !== undefined) {
                        if (row.searchkey.indexOf(q) > -1) {
                            q1 = row[opts.textField];
                        }
                        if (row.searchkey.toLowerCase() == q.toLowerCase()) {
                            _a03 = row[opts.valueField];
                            _9e6(_9ff, row[opts.valueField], true);
                        }
                    }
                    if (opts.filter.call(_9ff, q1, row)) {
                        /*pls2018-4-2增加下拉框拼音匹配****结束*/
...
// xyzxyzxyz  end
    ...
    $.fn.combobox.methods = {
        options: function (jq) {
            ...
            return jq.each(function () {
                ...
                _a19.find("div.combobox-item-selected").removeClass("combobox-item-selected  iconfont icon-comboboxItemSelected");
            });
        }, reset: function (jq) {
            return jq.each(function () {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        ...
        view: _a23,
        keyHandler: {
            up: function (e) {//xyzxyzxyz limitToList: false,
                nav(this, "prev");
                e.preventDefault();
            }, down: function (e) {
                nav(this, "next");
...
// _a05(this);
        ...
        inputEvents: $.extend({}, $.fn.combo.defaults.inputEvents, {//xyzxyzxyz
            blur: function (e) {
