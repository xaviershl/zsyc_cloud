...
},beforePageText:"Page",afterPageText:"of {pages}",displayMsg:"Displaying {from} to {to} of {total} items",nav:{first:{iconCls:"pagination-first iconfont icon-paginationFirst",handler:function(){
var _d8=$(this).pagination("options");
if(_d8.pageNumber>1){
$(this).pagination("select",1);
}
}},prev:{iconCls:"pagination-prev iconfont icon-paginationPrev",handler:function(){
var _d9=$(this).pagination("options");
if(_d9.pageNumber>1){
$(this).pagination("select",_d9.pageNumber-1);
}
}},next:{iconCls:"pagination-next iconfont icon-paginationNext",handler:function(){
var _da=$(this).pagination("options");
var _db=Math.ceil(_da.total/_da.pageSize);
if(_da.pageNumber<_db){
$(this).pagination("select",_da.pageNumber+1);
}
}},last:{iconCls:"pagination-last iconfont icon-paginationLast",handler:function(){
var _dc=$(this).pagination("options");
var _dd=Math.ceil(_dc.total/_dc.pageSize);
if(_dc.pageNumber<_dd){
$(this).pagination("select",_dd);
}
}},refresh:{iconCls:"pagination-refresh iconfont icon-paginationreFresh",handler:function(){
...
$.fn.menubutton.defaults=$.extend({},$.fn.linkbutton.defaults,{plain:true,hasDownArrow:true,menu:null,menuAlign:"left",duration:100,cls:{btn1:"m-btn-active",btn2:"m-btn-plain-active",arrow:"m-btn-downarrow iconfont icon-downarrow",trigger:"m-btn"}});
})(jQuery);
(function($){
function init(_450){
...
if(opts.hasDownArrow){
_99e.push({iconCls:"combo-arrow iconfont icon-comboArrow",handler:function(e){
_9a2(e.data.target);
}});
}
...
var t=$(_a1d);
return $.extend({},$.fn.combo.parseOptions(_a1d),$.parser.parseOptions(_a1d,["valueField","textField","groupField","groupPosition","mode","method","url",{showItemIcon:"boolean",limitToList:'boolean'}]));//xyzxyzxyz ,limitToList:'boolean'}
};
...
return _a28;
},mode:"local",method:"post",url:null,data:null,queryParams:{},showItemIcon:false,limitToList: false,view:_a23,keyHandler:{up:function(e){//xyzxyzxyz limitToList: false,
nav(this,"prev");
e.preventDefault();
},down:function(e){
nav(this,"next");
