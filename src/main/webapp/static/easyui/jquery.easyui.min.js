...
tool.addClass("panel-tool-expand icon-expand");
if(_246==true){
...
$.fn.menubutton.defaults=$.extend({},$.fn.linkbutton.defaults,{plain:true,hasDownArrow:true,menu:null,menuAlign:"left",duration:100,cls:{btn1:"m-btn-active",btn2:"m-btn-plain-active",arrow:"iconfont icon-downarrow",trigger:"m-btn"}});
})(jQuery);
(function($){
function init(_450){
...
_854.push("<span class=\"datagrid-row-expander\">&nbsp;</span>");
_854.push("</span>");
}
if(!_851){
